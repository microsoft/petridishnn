    ...
    def _trigger(self):
        ...
        while True:
            try:
                ...
                logger.exception("Exception in ModelSaver! trial={}".format(n_trials))
            except Exception as e:
                logger.exception("Unknown exception in ModelSaver! trial={} e={}".format(n_trials, e))
            n_trials += 1
            if n_trials >= min(self.max_n_trials, 10):
                break
            time_module.sleep(3)
