...
log_dir=${GLOBAL_LOG_DIR}/test_ptb
model_dir=${GLOBAL_MODEL_DIR}/test_ptb
...
--model_rnn_num_lstms=1 \
--model_rnn_num_units=850 \
...
--regularize_const=5e-7 \
--s_type=basic \
--sgd_moment=0.9 \
--stem_channel_rate=3.0 \
--training_type=petridish \
--use_hallu_feat_sel \
--w_init=var_scale \
> $log_dir/stdout.txt
#--debug_steps_per_epoch=20 \
